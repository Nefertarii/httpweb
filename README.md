...
-----------
	...
	2021-3-23 修改:重新修改主体函数 目前过于混乱 制作成类方便管理
	2021-3-24 问题:莫名崩溃    已解决(2021-3-24)之前有时候程序自动退出 发现是 系统信号-SIGPIPE 的原因
	2021-3-25 修改:重构了所有函数 服务器操作制作成了类方便使用 同时基础的绑定、读、写等函数均完善并添加了异常处理\n且添加了缓存在写操作时防止数据量过大无法一次写完 
